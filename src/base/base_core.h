...
#else
// NOTE(tec): I don't know of a useful way to do this in GCC land.
...
////////////////////////////////
//~ tec: Linked List Building Macros

//- tec: linked list macro helpers
#define CheckNil(nil,p) ((p) == 0 || (p) == nil)
#define SetNil(nil,p) ((p) = nil)

//- tec: doubly-linked-lists
...
//- tec: singly-linked, doubly-headed lists (queues)
...
//- tec: singly-linked, singly-headed lists (stacks)
#define SLLStackPush_N(f,n,next) ((n)->next=(f), (f)=(n))
#define SLLStackPop_N(f,next) ((f)=(f)->next)

//- tec: doubly-linked-list helpers
...
//- tec: singly-linked, doubly-headed list helpers
...
//- tec: singly-linked, singly-headed list helpers
#define SLLStackPush(f,n) SLLStackPush_N(f,n,next)
#define SLLStackPop(f) SLLStackPop_N(f,next)

////////////////////////////////
//~ tec: Address Sanitizer Markup
...
#define AlignDown(x, align) ((x) & ~((align) - 1))
...
////////////////////////////////
//~ tec: Toolchain/Environment Enums
...
////////////////////////////////
//~ tec: Text 2D Coordinates & Ranges
...
////////////////////////////////
//~ tec: Memory Functions

internal B32 memory_is_zero(void *ptr, U64 size);

////////////////////////////////
//~ tec: Text 2D Coordinate/Range Functions
...
////////////////////////////////
//~ tec: Toolchain/Environment Enum Functions

internal U64 bit_size_from_architecture(Architecture arch);
internal U64 max_instruction_size_from_architecture(Architecture arch);
...
////////////////////////////////
//~ tec: Non-Fancy Ring Buffer Reads/Writes
