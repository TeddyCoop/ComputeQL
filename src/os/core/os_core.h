...
////////////////////////////////
//~ tec: Handle Type Functions (Helpers, Implemented Once)
...
////////////////////////////////
//~ tec: Command Line Argc/Argv Helper (Helper, Implemented Once)

internal String8List os_string_list_from_argcv(Arena *arena, int argc, char **argv);

////////////////////////////////
//~ tec: Filesystem Helpers (Helpers, Implemented Once)
...
////////////////////////////////
//~ tec: GUID Helpers (Helpers, Implemented Once)
...
// NOTE(tec): The implementation of `os_core` will define low-level entry
